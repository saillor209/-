...
if __name__ == "__main__":
    ...
    def run():
        ...
        for ext in video_extensions:
            files = glob.glob(os.path.join(preferences.video_input_path, ext))
            if files:
    ...
    run_button.pack(side=LEFT, padx=(12, 0), pady=(0, 12))
    # Stop Button (아직 기능이 없음 ㅋㅋ)
    ...
    # Auto Scrool Check Box (어작 기능이 업음 ㅋㅋㅋ)
    ...
    def file_preference():
        width, height, x, y = center_calc(500, 400, 30)
